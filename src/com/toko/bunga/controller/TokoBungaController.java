...
public class TokoBungaController {
    ...
    public void getAllData(){
        ...
        this.tokoBungaView.getTbl_Bunga().setModel(tokoBungaTableModel);
    }
    
    public void getdata(){
        int rowIndex = this.tokoBungaView.getTbl_Bunga().getSelectedRow();
        this.tokoBungaView.getTxtKode().setText(String.valueOf(this.tokoBungaView.getTbl_Bunga().getValueAt(rowIndex, 0)));
        this.tokoBungaView.getTxtNama().setText(String.valueOf(this.tokoBungaView.getTbl_Bunga().getValueAt(rowIndex, 1)));
        this.tokoBungaView.getTxtJenis().setText(String.valueOf(this.tokoBungaView.getTbl_Bunga().getValueAt(rowIndex, 2)));
        this.tokoBungaView.getTxtHarga().setText(String.valueOf(this.tokoBungaView.getTbl_Bunga().getValueAt(rowIndex, 3)));
    }
}
